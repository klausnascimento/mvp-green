                    ...
                    <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                        <div class="card card-plain mt-8">
                            <div class="card-header pb-0 text-left bg-transparent">
                                <h3 class="font-weight-bolder text-info text-gradient"><?php echo e(__('Welcome')); ?></h3>
                            </div>
                            <div class="card-body">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <p class="text-sm mt-3 mb-0"><?php echo e(__('Already have an account? ')); ?><a
...
<?php /**PATH /var/www/html/klaus/mvp-green/resources/views/livewire/auth/sign-up.blade.php ENDPATH**/ ?>